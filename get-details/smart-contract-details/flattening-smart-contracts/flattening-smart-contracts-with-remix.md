...
* [🧭 Table of contents](flattening-smart-contracts-with-remix.md#-table-of-contents)
* [📰 Overview](flattening-smart-contracts-with-remix.md#-overview)
  * [What you will learn](flattening-smart-contracts-with-remix.md#what-you-will-learn)
  * [What you will do](flattening-smart-contracts-with-remix.md#what-you-will-do)
  * [📰 About Openzeppelin](flattening-smart-contracts-with-remix.md#-about-openzeppelin)
* [🚀 Setting up the development environment](flattening-smart-contracts-with-remix.md#-setting-up-the-development-environment)
  * [⚒️ Creating XDCPay Wallet for signing transactions](flattening-smart-contracts-with-remix.md#️-creating-xdcpay-wallet-for-signing-transactions)
  * [⚒ Adding Testnet XDC to Development Wallet](flattening-smart-contracts-with-remix.md#-adding-testnet-xdc-to-development-wallet)
* [💵 Writing our first OpenZeppelin Contract](flattening-smart-contracts-with-remix.md#-writing-our-first-openzeppelin-contract)
  * [💵 OpenZeppelin](flattening-smart-contracts-with-remix.md#-openzeppelin)
  * [💵 Methods](flattening-smart-contracts-with-remix.md#-methods)
  * [💵 Compiling and Deploying](flattening-smart-contracts-with-remix.md#-compiling-and-deploying)
  * [💵 Flattening our smart contract](flattening-smart-contracts-with-remix.md#-flattening-our-smart-contract)
* [🔍 Verifying Contracts on the Block Explorer](flattening-smart-contracts-with-remix.md#-verifying-contracts-on-the-block-explorer)
  * [🔍 Interacting with your contract on the Block Explorer](flattening-smart-contracts-with-remix.md#-interacting-with-your-contract-on-the-block-explorer)
